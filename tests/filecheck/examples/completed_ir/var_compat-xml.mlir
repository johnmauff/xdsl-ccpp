...
// fidelity and a dummy-argument-name collision are separate, already-tracked,
// out-of-scope issues -- the latter shows up below as three arguments named
// literally 'scalar_var' in the same subroutine signature).
//
...
// CHECK-NEXT:   builtin.module @var_compatibility_suite_cap {
...
// CHECK-NEXT:     }) : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "nci_out", base_type = "real", rank = 2 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "effri_out", base_type = "real", rank = 2 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "ncl_out", base_type = "real", rank = 2 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     func.func public @var_compatibility_suite_suite_register() -> (memref<i32>, memref<512xi8>) {
...
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @var_compatibility_suite_suite_initialize(%scheme_order : memref<i32>) -> (memref<i32>, memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @var_compatibility_suite_suite_finalize() -> (memref<i32>, memref<512xi8>) {
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errflg, %errmsg : memref<i32>, memref<512xi8>
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @var_compatibility_suite_suite_timestep_initial() -> (memref<i32>, memref<512xi8>) {
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errflg, %errmsg : memref<i32>, memref<512xi8>
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @var_compatibility_suite_suite_timestep_final() -> (memref<i32>, memref<512xi8>) {
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errflg, %errmsg : memref<i32>, memref<512xi8>
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @var_compatibility_suite_suite_radiation(%effrr_inout : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %scalar_var : memref<!ccpp_utils.real_kind<"kind_phys">>, %ncol : memref<i32>, %nlev : memref<i32>, %effrg_in__opt : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %ncg_in__opt : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %nci_out__opt : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %effrl_inout : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %effri_out__opt : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %effrs_inout : memref<?x?x!ccpp_utils.real_kind<"8">>, %ncl_out__opt : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %has_graupel : memref<i1>, %scalar_var_1 : memref<!ccpp_utils.real_kind<"kind_phys">>, %tke_inout : memref<!ccpp_utils.real_kind<"kind_phys">>, %tke2_inout : memref<!ccpp_utils.real_kind<"kind_phys">>, %scalar_var_2 : memref<!ccpp_utils.real_kind<"kind_phys">>, %scalar_var_3 : memref<i32>, %fluxLW : memref<?x!ccpp_utils.derived_type<"ty_rad_lw">>, %sfc_up_sw : memref<?x!ccpp_utils.real_kind<"kind_phys">>, %sfc_down_sw : memref<?x!ccpp_utils.real_kind<"kind_phys">>) -> (memref<i32>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:         %12 = memref.load %errflg[] : memref<i32>
// CHECK-NEXT:         scf.if %11 {
// CHECK-NEXT:           %13 = builtin.unrealized_conversion_cast %scalar_var_3 : memref<i32> to memref<!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:           func.call @effr_pre_run(%effrr_inout, %13, %errmsg, %errflg) : (memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>) -> ()
// CHECK-NEXT:         }
...
// CHECK-NEXT:           %21 = builtin.unrealized_conversion_cast %scalar_var_3 : memref<i32> to memref<!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:           func.call @effr_post_run(%effrr_inout, %21, %errmsg, %errflg) : (memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>) -> ()
// CHECK-NEXT:         }
// CHECK-NEXT:       }) : (memref<i32>) -> ()
...
// CHECK-NEXT:           %25 = builtin.unrealized_conversion_cast %effrs_inout : memref<?x?x!ccpp_utils.real_kind<"8">> to memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:           func.call @effrs_calc_run(%25, %errmsg, %errflg) : (memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>) -> ()
// CHECK-NEXT:         }
// CHECK-NEXT:       }) : (memref<i32>) -> ()
...
// CHECK-NEXT:         func.call @effr_diag_run(%effrr_inout, %scalar_var_3, %errmsg, %errflg) : (memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<i32>, memref<512xi8>, memref<i32>) -> ()
// CHECK-NEXT:       }
...
// CHECK-NEXT:       %33 = arith.cmpi eq, %34, %32 : i32
...
// CHECK-NEXT:       }
// CHECK-NEXT:       func.return %scalar_var_3, %tke_inout, %tke2_inout, %errmsg, %errflg : memref<i32>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func private @effr_pre_init(memref<i32>, memref<512xi8>, memref<i32>) -> () attributes {module = "effr_pre"} 
// CHECK-NEXT:     func.func private @effr_calc_init(memref<i32>, memref<512xi8>, memref<i32>) -> () attributes {module = "effr_calc"} 
// CHECK-NEXT:     func.func private @effr_post_init(memref<i32>, memref<512xi8>, memref<i32>) -> () attributes {module = "effr_post"} 
// CHECK-NEXT:     func.func private @effr_diag_init(memref<i32>, memref<512xi8>, memref<i32>) -> () attributes {module = "effr_diag"} 
// CHECK-NEXT:     func.func private @effr_pre_run(memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>) -> () attributes {module = "effr_pre"} 
// CHECK-NEXT:     func.func private @effr_calc_run(memref<i32>, memref<i32>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"8">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<i1>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>) -> () attributes {module = "effr_calc"} 
// CHECK-NEXT:     func.func private @effr_post_run(memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>) -> () attributes {module = "effr_post"} 
// CHECK-NEXT:     func.func private @effrs_calc_run(memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>) -> () attributes {module = "effrs_calc"} 
// CHECK-NEXT:     func.func private @effr_diag_run(memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<i32>, memref<512xi8>, memref<i32>) -> () attributes {module = "effr_diag"} 
// CHECK-NEXT:     func.func private @rad_lw_run(memref<i32>, memref<?x!ccpp_utils.derived_type<"ty_rad_lw">>, memref<512xi8>, memref<i32>) -> () attributes {module = "rad_lw"} 
// CHECK-NEXT:     func.func private @rad_sw_run(memref<i32>, memref<?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>) -> () attributes {module = "rad_sw"} 
// CHECK-NEXT:   }
// CHECK-NEXT:   builtin.module @VarCompatibility_ccpp_cap {
...
// CHECK-NEXT:     func.func public @VarCompatibility_ccpp_physics_register(%suite_name : memref<?xi8>) -> (memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @VarCompatibility_ccpp_physics_initialize(%suite_name : memref<?xi8>) -> (memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
...
// CHECK-NEXT:       func.return %errmsg, %errflg : memref<512xi8>, memref<i32>
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @VarCompatibility_ccpp_physics_finalize(%suite_name : memref<?xi8>) -> (memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errmsg, %errflg : memref<512xi8>, memref<i32>
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @VarCompatibility_ccpp_physics_timestep_initial(%suite_name : memref<?xi8>) -> (memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errmsg, %errflg : memref<512xi8>, memref<i32>
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @VarCompatibility_ccpp_physics_timestep_final(%suite_name : memref<?xi8>) -> (memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errmsg, %errflg : memref<512xi8>, memref<i32>
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @VarCompatibility_ccpp_physics_run(%suite_name : memref<?xi8>, %suite_part : memref<?xi8>, %ncol : memref<i32>, %nlev : memref<i32>, %effrs_inout : memref<?x?x!ccpp_utils.real_kind<"8">>, %has_graupel : memref<i1>, %errmsg : memref<512xi8>, %errflg : memref<i32>) -> (memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
// CHECK-NEXT:       %1 = "ccpp_utils.trim"(%suite_name) : (memref<?xi8>) -> memref<?xi8>
// CHECK-NEXT:       %2 = "ccpp_utils.strcmp"(%1) <{literal = "var_compatibility_suite"}> : (memref<?xi8>) -> i1
...
// CHECK-NEXT:         %4 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_effrr_inout"}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %5 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_scalar_var"}> : () -> memref<!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %6 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_effrg_in"}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %7 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_ncg_in"}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %8 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_nci_out"}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %9 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_effrl_inout"}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %10 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_effri_out"}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %11 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_ncl_out"}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %12 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_scalar_var"}> : () -> memref<!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %13 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_tke_inout"}> : () -> memref<!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %14 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_tke2_inout"}> : () -> memref<!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %15 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_scalar_var"}> : () -> memref<!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %16 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_scalar_var"}> : () -> memref<i32>
// CHECK-NEXT:         %17 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_fluxLW"}> : () -> memref<?x!ccpp_utils.derived_type<"ty_rad_lw">>
// CHECK-NEXT:         %18 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_sfc_up_sw"}> : () -> memref<?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %19 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_sfc_down_sw"}> : () -> memref<?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:         %20 = "ccpp_utils.strcmp"(%3) <{literal = "radiation"}> : (memref<?xi8>) -> i1
// CHECK-NEXT:         scf.if %20 {
// CHECK-NEXT:           %21, %22, %23, %24, %25 = "ccpp_utils.kw_call"(%4, %16, %ncol, %nlev, %6, %7, %8, %9, %10, %effrs_inout, %11, %has_graupel, %16, %13, %14, %16, %16, %17, %18, %19) <{callee = "var_compatibility_suite_suite_radiation", operand_names = ["effrr_inout", "scalar_var", "ncol", "nlev", "effrg_in", "ncg_in", "nci_out", "effrl_inout", "effri_out", "effrs_inout", "ncl_out", "has_graupel", "scalar_var", "tke_inout", "tke2_inout", "scalar_var", "scalar_var", "fluxLW", "sfc_up_sw", "sfc_down_sw"], result_names = ["errflg", "_out_1", "_out_2", "errmsg", "errflg"], overrides = {}}> : (memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<i32>, memref<i32>, memref<i32>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"8">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<i1>, memref<i32>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<i32>, memref<i32>, memref<?x!ccpp_utils.derived_type<"ty_rad_lw">>, memref<?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x!ccpp_utils.real_kind<"kind_phys">>) -> (memref<i32>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>)
...
// CHECK-NEXT:           memref.store %26, %errflg[] : memref<i32>
// CHECK-NEXT:         }
// CHECK-NEXT:       } else {
// CHECK-NEXT:         "ccpp_utils.write_errmsg"(%errmsg, %1) <{prefix = "No suite named ", suffix = " found"}> : (memref<512xi8>, memref<?xi8>) -> ()
...
// CHECK-NEXT:       func.return %errmsg, %errflg : memref<512xi8>, memref<i32>
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @ccpp_physics_suite_list(%suites : memref<memref<?xi8>>) {
...
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func public @ccpp_physics_suite_part_list(%suite_name : memref<?xi8>, %part_list : memref<memref<?xi8>>) -> (memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_effrr_inout", base_type = "real", rank = 2 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_scalar_var", base_type = "real", rank = 0 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_effrg_in", base_type = "real", rank = 2 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_ncg_in", base_type = "real", rank = 2 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_nci_out", base_type = "real", rank = 2 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_effrl_inout", base_type = "real", rank = 2 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_effri_out", base_type = "real", rank = 2 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_ncl_out", base_type = "real", rank = 2 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_tke_inout", base_type = "real", rank = 0 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_tke2_inout", base_type = "real", rank = 0 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_fluxLW", base_type = "real", rank = 1 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_sfc_up_sw", base_type = "real", rank = 1 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.module_var"() <{var_name = "lc_sfc_down_sw", base_type = "real", rank = 1 : i64, kind = "kind_phys"}> : () -> ()
// CHECK-NEXT:     "ccpp_utils.constituent_api"() <{body = "  subroutine VarCompatibility_ccpp_is_scheme_constituent(std_name, is_const, errflg, errmsg)\n    character(len=*), intent(in) :: std_name\n    logical, intent(out) :: is_const\n    integer, intent(out) :: errflg\n    character(len=512), intent(out) :: errmsg\n    integer :: lc_idx\n    errflg = 0\n    errmsg = ''\n    is_const = .false.\n    select case (trim(std_name))\n    case default\n    end select\n  end subroutine VarCompatibility_ccpp_is_scheme_constituent\n\n  subroutine VarCompatibility_ccpp_deallocate_dynamic_constituents()\n    if (allocated(lc_all_constituents)) deallocate(lc_all_constituents)\n    if (allocated(lc_const_props)) deallocate(lc_const_props)\n    if (allocated(lc_constituent_array)) deallocate(lc_constituent_array)\n    if (allocated(lc_const_tend)) deallocate(lc_const_tend)\n    if (allocated(lc_effrr_inout)) deallocate(lc_effrr_inout)\n    if (allocated(lc_scalar_var)) deallocate(lc_scalar_var)\n    if (allocated(lc_effrg_in)) deallocate(lc_effrg_in)\n    if (allocated(lc_ncg_in)) deallocate(lc_ncg_in)\n    if (allocated(lc_nci_out)) deallocate(lc_nci_out)\n    if (allocated(lc_effrl_inout)) deallocate(lc_effrl_inout)\n    if (allocated(lc_effri_out)) deallocate(lc_effri_out)\n    if (allocated(lc_ncl_out)) deallocate(lc_ncl_out)\n    if (allocated(lc_tke_inout)) deallocate(lc_tke_inout)\n    if (allocated(lc_tke2_inout)) deallocate(lc_tke2_inout)\n    if (allocated(lc_fluxLW)) deallocate(lc_fluxLW)\n    if (allocated(lc_sfc_up_sw)) deallocate(lc_sfc_up_sw)\n    if (allocated(lc_sfc_down_sw)) deallocate(lc_sfc_down_sw)\n  end subroutine VarCompatibility_ccpp_deallocate_dynamic_constituents\n\n  subroutine VarCompatibility_ccpp_register_constituents(host_constituents, errmsg, errflg)\n    use ccpp_scheme_utils, only: ccpp_scheme_utils_set_constituents\n    type(ccpp_constituent_properties_t), intent(in) :: host_constituents(:)\n    character(len=512), intent(out) :: errmsg\n    integer, intent(out) :: errflg\n    integer :: lc_max, lc_num, lc_i, lc_j\n    logical :: lc_found\n    type(ccpp_constituent_properties_t), allocatable :: lc_tmp(:)\n    errflg = 0\n    errmsg = ''\n    lc_max = 0\n    lc_max = lc_max + 0\n    lc_max = lc_max + size(host_constituents)\n    allocate(lc_tmp(lc_max))\n    lc_num = 0\n    do lc_i = 1, size(host_constituents)\n      lc_found = .false.\n      do lc_j = 1, lc_num\n        if (trim(lc_tmp(lc_j)%std_name) == trim(host_constituents(lc_i)%std_name)) then\n          lc_found = .true.\n          if (trim(lc_tmp(lc_j)%units) /= trim(host_constituents(lc_i)%units)) then\n            write(errmsg, '(3a)') 'ccp_model_const_add_metadata ERROR: Trying to add constituent ', trim(host_constituents(lc_i)%std_name), &\n              ' but an incompatible constituent with this name already exists'\n            errflg = 1\n            return\n          end if\n          exit\n        end if\n      end do\n      if (.not. lc_found) then\n        lc_num = lc_num + 1\n        lc_tmp(lc_num) = host_constituents(lc_i)\n      end if\n    end do\n    if (allocated(lc_all_constituents)) deallocate(lc_all_constituents)\n    allocate(lc_all_constituents(lc_num))\n    lc_all_constituents(1:lc_num) = lc_tmp(1:lc_num)\n    deallocate(lc_tmp)\n    if (allocated(lc_const_props)) deallocate(lc_const_props)\n    allocate(lc_const_props(lc_num))\n    do lc_i = 1, lc_num\n      lc_const_props(lc_i)%ptr => lc_all_constituents(lc_i)\n    end do\n    call ccpp_scheme_utils_set_constituents(lc_all_constituents)\n  end subroutine VarCompatibility_ccpp_register_constituents\n\n  subroutine VarCompatibility_ccpp_number_constituents(num_advected, errmsg, errflg)\n    integer, intent(out) :: num_advected\n    character(len=512), intent(out) :: errmsg\n    integer, intent(out) :: errflg\n    errflg = 0\n    errmsg = ''\n    if (allocated(lc_all_constituents)) then\n      num_advected = size(lc_all_constituents)\n    else\n      num_advected = 0\n    end if\n  end subroutine VarCompatibility_ccpp_number_constituents\n\n  subroutine VarCompatibility_ccpp_initialize_constituents(ncols, pver, errflg, errmsg)\n    integer, intent(in) :: ncols\n    integer, intent(in) :: pver\n    integer, intent(out) :: errflg\n    character(len=512), intent(out) :: errmsg\n    integer :: lc_num, lc_i\n    errflg = 0\n    errmsg = ''\n    if (.not. allocated(lc_all_constituents)) then\n      errflg = 1\n      errmsg = 'ccpp_initialize_constituents: register_constituents not called'\n      return\n    end if\n    lc_num = size(lc_all_constituents)\n    if (allocated(lc_constituent_array)) deallocate(lc_constituent_array)\n    allocate(lc_constituent_array(ncols, pver, lc_num))\n    lc_constituent_array = 0.0_kind_phys\n    do lc_i = 1, lc_num\n      if (lc_all_constituents(lc_i)%default_val_set) then\n        lc_constituent_array(:, :, lc_i) = lc_all_constituents(lc_i)%default_val\n      end if\n    end do\n    if (allocated(lc_const_tend)) deallocate(lc_const_tend)\n    allocate(lc_const_tend(ncols, pver, lc_num))\n    lc_const_tend = 0.0_kind_phys\n    if (allocated(lc_effrr_inout)) deallocate(lc_effrr_inout)\n    allocate(lc_effrr_inout(ncols, pver))\n    lc_effrr_inout = 0.0_kind_phys\n    if (allocated(lc_scalar_var)) deallocate(lc_scalar_var)\n    allocate(lc_scalar_var(ncols, pver))\n    lc_scalar_var = 0.0_kind_phys\n    if (allocated(lc_effrg_in)) deallocate(lc_effrg_in)\n    allocate(lc_effrg_in(ncols, pver))\n    lc_effrg_in = 0.0_kind_phys\n    if (allocated(lc_ncg_in)) deallocate(lc_ncg_in)\n    allocate(lc_ncg_in(ncols, pver))\n    lc_ncg_in = 0.0_kind_phys\n    if (allocated(lc_nci_out)) deallocate(lc_nci_out)\n    allocate(lc_nci_out(ncols, pver))\n    lc_nci_out = 0.0_kind_phys\n    if (allocated(lc_effrl_inout)) deallocate(lc_effrl_inout)\n    allocate(lc_effrl_inout(ncols, pver))\n    lc_effrl_inout = 0.0_kind_phys\n    if (allocated(lc_effri_out)) deallocate(lc_effri_out)\n    allocate(lc_effri_out(ncols, pver))\n    lc_effri_out = 0.0_kind_phys\n    if (allocated(lc_ncl_out)) deallocate(lc_ncl_out)\n    allocate(lc_ncl_out(ncols, pver))\n    lc_ncl_out = 0.0_kind_phys\n    if (allocated(lc_tke_inout)) deallocate(lc_tke_inout)\n    allocate(lc_tke_inout(ncols, pver))\n    lc_tke_inout = 0.0_kind_phys\n    if (allocated(lc_tke2_inout)) deallocate(lc_tke2_inout)\n    allocate(lc_tke2_inout(ncols, pver))\n    lc_tke2_inout = 0.0_kind_phys\n    if (allocated(lc_fluxLW)) deallocate(lc_fluxLW)\n    allocate(lc_fluxLW(ncols))\n    lc_fluxLW = 0.0_kind_phys\n    if (allocated(lc_sfc_up_sw)) deallocate(lc_sfc_up_sw)\n    allocate(lc_sfc_up_sw(ncols))\n    lc_sfc_up_sw = 0.0_kind_phys\n    if (allocated(lc_sfc_down_sw)) deallocate(lc_sfc_down_sw)\n    allocate(lc_sfc_down_sw(ncols))\n    lc_sfc_down_sw = 0.0_kind_phys\n  end subroutine VarCompatibility_ccpp_initialize_constituents\n\n  function VarCompatibility_constituents_array() result(ptr)\n    real(kind=kind_phys), pointer :: ptr(:, :, :)\n    ptr => lc_constituent_array\n  end function VarCompatibility_constituents_array\n\n  subroutine VarCompatibility_const_get_index(std_name, index, errflg, errmsg)\n    character(len=*), intent(in) :: std_name\n    integer, intent(out) :: index\n    integer, intent(out) :: errflg\n    character(len=512), intent(out) :: errmsg\n    integer :: lc_i\n    errflg = 0\n    errmsg = ''\n    index = -1\n    if (.not. allocated(lc_all_constituents)) then\n      errflg = 1\n      errmsg = 'const_get_index: constituents not registered'\n      return\n    end if\n    do lc_i = 1, size(lc_all_constituents)\n      if (trim(lc_all_constituents(lc_i)%std_name) == trim(std_name)) then\n        index = lc_i\n        return\n      end if\n    end do\n    errflg = 1\n    write(errmsg, '(3a)') 'const_get_index: constituent ', trim(std_name), ' not found'\n  end subroutine VarCompatibility_const_get_index\n\n  function VarCompatibility_model_const_properties() result(ptr)\n    type(ccpp_constituent_prop_ptr_t), pointer :: ptr(:)\n    ptr => lc_const_props\n  end function VarCompatibility_model_const_properties", public_names = ["VarCompatibility_ccpp_is_scheme_constituent", "VarCompatibility_ccpp_deallocate_dynamic_constituents", "VarCompatibility_ccpp_register_constituents", "VarCompatibility_ccpp_number_constituents", "VarCompatibility_ccpp_initialize_constituents", "VarCompatibility_constituents_array", "VarCompatibility_const_get_index", "VarCompatibility_model_const_properties"]}> : () -> ()
// CHECK-NEXT:     func.func private @var_compatibility_suite_suite_register() -> (memref<i32>, memref<512xi8>) attributes {module = "var_compatibility_suite_cap"} 
// CHECK-NEXT:     func.func private @var_compatibility_suite_suite_initialize(memref<i32>) -> (memref<512xi8>, memref<i32>) attributes {module = "var_compatibility_suite_cap"} 
// CHECK-NEXT:     func.func private @var_compatibility_suite_suite_finalize() -> (memref<i32>, memref<512xi8>) attributes {module = "var_compatibility_suite_cap"} 
// CHECK-NEXT:     func.func private @var_compatibility_suite_suite_timestep_initial() -> (memref<i32>, memref<512xi8>) attributes {module = "var_compatibility_suite_cap"} 
// CHECK-NEXT:     func.func private @var_compatibility_suite_suite_timestep_final() -> (memref<i32>, memref<512xi8>) attributes {module = "var_compatibility_suite_cap"} 
// CHECK-NEXT:     func.func private @var_compatibility_suite_suite_radiation(memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<i32>, memref<i32>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"8">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<i1>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<i32>, memref<?x!ccpp_utils.derived_type<"ty_rad_lw">>, memref<?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x!ccpp_utils.real_kind<"kind_phys">>) -> (memref<i32>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<512xi8>, memref<i32>) attributes {module = "var_compatibility_suite_cap"} 
// CHECK-NEXT:   }
