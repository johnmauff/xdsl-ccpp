...
// CHECK-NEXT:     }
// CHECK-LABEL:     func.func public @hello_world_suite_suite_initialize() -> (memref<i32>, memref<512xi8>) {
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errflg, %errmsg : memref<i32>, memref<512xi8>
// CHECK-NEXT:     }
// CHECK-LABEL:     func.func public @hello_world_suite_suite_finalize() -> (memref<i32>, memref<512xi8>) {
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errflg, %errmsg : memref<i32>, memref<512xi8>
// CHECK-NEXT:     }
// CHECK-LABEL:     func.func public @hello_world_suite_suite_init_physics() -> (memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:     }
// CHECK-LABEL:     func.func public @hello_world_suite_suite_physics(%ncol : memref<i32>, %lev : memref<i32>, %ilev : memref<i32>, %timestep : memref<!ccpp_utils.real_kind<"kind_phys">>, %temp_level : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %temp_layer : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>) -> (memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errmsg, %errflg : memref<512xi8>, memref<i32>
// CHECK-NEXT:     }
// CHECK-LABEL:     func.func public @hello_world_suite_suite_timestep_init_physics() -> (memref<i32>, memref<512xi8>) {
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errflg, %errmsg : memref<i32>, memref<512xi8>
// CHECK-NEXT:     }
// CHECK-LABEL:     func.func public @hello_world_suite_suite_timestep_final_physics() -> (memref<i32>, memref<512xi8>) {
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       func.return %errflg, %errmsg : memref<i32>, memref<512xi8>
// CHECK-NEXT:     }
// CHECK-LABEL:     func.func public @hello_world_suite_suite_final_physics() -> (memref<512xi8>, memref<i32>) {
// CHECK-NEXT:       %errmsg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<512xi8>
// CHECK-NEXT:       %errflg = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<i32>
// CHECK-NEXT:       %0 = arith.constant 0 : i32
// CHECK-NEXT:       memref.store %0, %errflg[] : memref<i32>
...
// CHECK-NEXT:       %2 = "ccpp_utils.strcmp"(%1) <{literal = "hello_world_suite"}> : (memref<?xi8>) -> i1
// CHECK-NEXT:       scf.if %2 {
// CHECK-NEXT:         %3, %4 = func.call @hello_world_suite_suite_initialize() : () -> (memref<i32>, memref<512xi8>)
// CHECK-NEXT:         "memref.copy"(%3, %errflg) : (memref<i32>, memref<i32>) -> ()
// CHECK-NEXT:         "memref.copy"(%4, %errmsg) : (memref<512xi8>, memref<512xi8>) -> ()
// CHECK-NEXT:       } else {
// CHECK-NEXT:         "ccpp_utils.write_errmsg"(%errmsg, %1) <{prefix = "No suite named ", suffix = " found"}> : (memref<512xi8>, memref<?xi8>) -> ()
...
// CHECK-NEXT:       %2 = "ccpp_utils.strcmp"(%1) <{literal = "hello_world_suite"}> : (memref<?xi8>) -> i1
// CHECK-NEXT:       scf.if %2 {
// CHECK-NEXT:         %3, %4 = func.call @hello_world_suite_suite_finalize() : () -> (memref<i32>, memref<512xi8>)
// CHECK-NEXT:         "memref.copy"(%3, %errflg) : (memref<i32>, memref<i32>) -> ()
// CHECK-NEXT:         "memref.copy"(%4, %errmsg) : (memref<512xi8>, memref<512xi8>) -> ()
// CHECK-NEXT:       } else {
// CHECK-NEXT:         "ccpp_utils.write_errmsg"(%errmsg, %1) <{prefix = "No suite named ", suffix = " found"}> : (memref<512xi8>, memref<?xi8>) -> ()
...
// CHECK-NEXT:           %18, %19 = func.call @hello_world_suite_suite_physics(%ncol, %9, %10, %11, %15, %16) : (memref<i32>, memref<i32>, memref<i32>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>) -> (memref<512xi8>, memref<i32>)
...
// CHECK-NEXT:         scf.if %4 {
// CHECK-NEXT:           %5, %6 = func.call @hello_world_suite_suite_timestep_init_physics() : () -> (memref<i32>, memref<512xi8>)
...
// CHECK-NEXT:         %4 = "ccpp_utils.strcmp"(%3) <{literal = "physics"}> : (memref<?xi8>) -> i1
// CHECK-NEXT:         scf.if %4 {
// CHECK-NEXT:           %5, %6 = func.call @hello_world_suite_suite_timestep_final_physics() : () -> (memref<i32>, memref<512xi8>)
// CHECK-NEXT:           "memref.copy"(%5, %errflg) : (memref<i32>, memref<i32>) -> ()
// CHECK-NEXT:           "memref.copy"(%6, %errmsg) : (memref<512xi8>, memref<512xi8>) -> ()
// CHECK-NEXT:         } else {
// CHECK-NEXT:           "ccpp_utils.write_errmsg"(%errmsg, %3) <{prefix = "No suite part named ", suffix = " found in suite hello_world_suite"}> : (memref<512xi8>, memref<?xi8>) -> ()
...
// CHECK-NEXT:         %4 = "ccpp_utils.strcmp"(%3) <{literal = "physics"}> : (memref<?xi8>) -> i1
// CHECK-NEXT:         scf.if %4 {
// CHECK-NEXT:           %5, %6 = func.call @hello_world_suite_suite_init_physics() : () -> (memref<512xi8>, memref<i32>)
...
// CHECK-NEXT:         %4 = "ccpp_utils.strcmp"(%3) <{literal = "physics"}> : (memref<?xi8>) -> i1
// CHECK-NEXT:         scf.if %4 {
// CHECK-NEXT:           %5, %6 = func.call @hello_world_suite_suite_final_physics() : () -> (memref<512xi8>, memref<i32>)
// CHECK-NEXT:           "memref.copy"(%5, %errmsg) : (memref<512xi8>, memref<512xi8>) -> ()
// CHECK-NEXT:           "memref.copy"(%6, %errflg) : (memref<i32>, memref<i32>) -> ()
// CHECK-NEXT:         } else {
// CHECK-NEXT:           "ccpp_utils.write_errmsg"(%errmsg, %3) <{prefix = "No suite part named ", suffix = " found in suite hello_world_suite"}> : (memref<512xi8>, memref<?xi8>) -> ()
...
// CHECK-NEXT:       %0 = arith.constant 17 : index
...
// CHECK-LABEL:     func.func private @hello_world_suite_suite_initialize() -> (memref<i32>, memref<512xi8>) attributes {module = "hello_world_suite_cap"} 
// CHECK-LABEL:     func.func private @hello_world_suite_suite_finalize() -> (memref<i32>, memref<512xi8>) attributes {module = "hello_world_suite_cap"} 
...
// CHECK-LABEL:     func.func private @hello_world_suite_suite_timestep_init_physics() -> (memref<i32>, memref<512xi8>) attributes {module = "hello_world_suite_cap"} 
// CHECK-LABEL:     func.func private @hello_world_suite_suite_timestep_final_physics() -> (memref<i32>, memref<512xi8>) attributes {module = "hello_world_suite_cap"} 
// CHECK-LABEL:     func.func private @hello_world_suite_suite_init_physics() -> (memref<512xi8>, memref<i32>) attributes {module = "hello_world_suite_cap"} 
// CHECK-LABEL:     func.func private @hello_world_suite_suite_final_physics() -> (memref<512xi8>, memref<i32>) attributes {module = "hello_world_suite_cap"} 
// CHECK-NEXT:   }
