...
// CHECK-NEXT:            %8 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_temp_level(:, :)"}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:            %9 = "ccpp_utils.cap_var_ref"() <{var_name = "lc_temp_layer(:, :)"}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:            %10, %11 = func.call @hello_world_suite_suite_physics(%col_start, %col_end, %5, %6, %7, %8, %9) : (memref<i32>, memref<i32>, memref<i32>, memref<i32>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>) -> (memref<512xi8>, memref<i32>)
