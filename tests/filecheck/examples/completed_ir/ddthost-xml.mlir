...
// CHECK-NEXT:        func.return %ccpp_info : memref<!ccpp_utils.derived_type<"ccpp_info_t">>
// CHECK-NEXT:      }
// CHECK-LABEL:     func.func public @Ddt_ccpp_physics_run(%suite_name : memref<?xi8>, %suite_part : memref<?xi8>, %ccpp_info : memref<!ccpp_utils.derived_type<"ccpp_info_t">>, %O3 : memref<?x!ccpp_utils.real_kind<"kind_phys">>, %HNO3 : memref<?x!ccpp_utils.real_kind<"kind_phys">>, %vmr : memref<!ccpp_utils.derived_type<"vmr_type">>, %psurf : memref<?x!ccpp_utils.real_kind<"kind_phys">>) -> memref<!ccpp_utils.derived_type<"ccpp_info_t">> {
