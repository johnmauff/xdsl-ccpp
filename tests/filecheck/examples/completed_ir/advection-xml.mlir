...
// CHECK-NEXT:      }
// CHECK-LABEL:     func.func public @cld_suite_suite_initialize(%const_std_name : memref<?xi8>, %num_consts : memref<i32>, %test_stdname_array__in : memref<?x?xi8>, %const_inds : memref<?xi32>, %tfreeze : memref<!ccpp_utils.real_kind<"kind_phys">>) -> (memref<i32>, memref<512xi8>, memref<i32>, memref<!ccpp_utils.real_kind<"kind_phys">>) {
...
// CHECK-NEXT:          func.call @const_indices_init(%const_std_name, %num_consts, %test_stdname_array__in, %const_index, %const_inds, %errmsg, %errflg) : (memref<?xi8>, memref<i32>, memref<?x?xi8>, memref<i32>, memref<?xi32>, memref<512xi8>, memref<i32>) -> ()
// CHECK-NEXT:        }
...
// CHECK-NEXT:        %18 = memref.load %errflg[] : memref<i32>
// CHECK-NEXT:        scf.if %17 {
// CHECK-NEXT:          func.call @const_indices_run(%const_std_name, %num_consts, %test_stdname_array__in, %const_index, %const_inds, %errmsg, %errflg) : (memref<?xi8>, memref<i32>, memref<?x?xi8>, memref<i32>, memref<?xi32>, memref<512xi8>, memref<i32>) -> ()
// CHECK-NEXT:        }
...
// CHECK-NEXT:        func.return %errmsg, %errflg : memref<512xi8>, memref<i32>
// CHECK-NEXT:      }
// CHECK-LABEL:     func.func public @Cld_ccpp_physics_run(%suite_name : memref<?xi8>, %suite_part : memref<?xi8>, %const_std_name : memref<?xi8>, %num_consts : memref<i32>, %test_stdname_array__in : memref<?x?xi8>, %const_inds : memref<?xi32>, %col_start : memref<i32>, %col_end : memref<i32>, %timestep : memref<!ccpp_utils.real_kind<"kind_phys">>, %tcld : memref<!ccpp_utils.real_kind<"kind_phys">>, %temp : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %qv : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %ps__in : memref<?x!ccpp_utils.real_kind<"kind_phys">>, %cld_liq_tend : memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, %const_tend : memref<?x?x?x!ccpp_utils.real_kind<"kind_phys">>, %const : memref<?x?x?x!ccpp_utils.real_kind<"kind_phys">>, %errmsg : memref<512xi8>, %errflg : memref<i32>) -> (memref<512xi8>, memref<i32>) {
...
// CHECK-NEXT:          scf.if %4 {
// CHECK-NEXT:            %5 = "ccpp_utils.host_var_ref"() <{var_name = "const_index", module_name = "test_host_data"}> : () -> memref<i32>
// CHECK-NEXT:            %6, %7, %8 = func.call @cld_suite_suite_physics(%const_std_name, %num_consts, %test_stdname_array__in, %const_inds, %col_start, %col_end, %timestep, %tcld, %temp, %qv, %ps__in, %cld_liq_tend, %const_tend, %const) : (memref<?xi8>, memref<i32>, memref<?x?xi8>, memref<?xi32>, memref<i32>, memref<i32>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x?x!ccpp_utils.real_kind<"kind_phys">>, memref<?x?x?x!ccpp_utils.real_kind<"kind_phys">>) -> (memref<i32>, memref<512xi8>, memref<i32>)
// CHECK-NEXT:            "memref.copy"(%6, %5) : (memref<i32>, memref<i32>) -> ()
