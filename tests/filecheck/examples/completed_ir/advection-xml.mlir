...
// CHECK-NEXT:        %13 = "ccpp_utils.host_var_ref"() <{var_name = "cld_ice_array", module_name = ""}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
...
// CHECK-NEXT:        %7 = "ccpp_utils.host_var_ref"() <{var_name = "lc_constituent_array", module_name = ""}> : () -> memref<?x?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:        "ccpp_utils.acc_exit_data"(%7) {operandSegmentSizes = array<i32: 0, 1>} : (memref<?x?x?x!ccpp_utils.real_kind<"kind_phys">>) -> ()
// CHECK-NEXT:        %8 = "ccpp_utils.host_var_ref"() <{var_name = "lc_qv", module_name = ""}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:        "ccpp_utils.acc_exit_data"(%8) {operandSegmentSizes = array<i32: 0, 1>} : (memref<?x?x!ccpp_utils.real_kind<"kind_phys">>) -> ()
// CHECK-NEXT:        %9 = "ccpp_utils.host_var_ref"() <{var_name = "lc_temp", module_name = ""}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:        "ccpp_utils.acc_exit_data"(%9) {operandSegmentSizes = array<i32: 0, 1>} : (memref<?x?x!ccpp_utils.real_kind<"kind_phys">>) -> ()
// CHECK-NEXT:        func.return %errmsg, %errflg : memref<512xi8>, memref<i32>
// CHECK-NEXT:      }
