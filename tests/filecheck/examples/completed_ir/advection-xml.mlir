...
// CHECK-NEXT:        }
// CHECK-NEXT:        %6 = "ccpp_utils.host_var_ref"() <{var_name = "lc_qv", module_name = ""}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
// CHECK-NEXT:        "ccpp_utils.acc_exit_data"(%6) {operandSegmentSizes = array<i32: 0, 1>} : (memref<?x?x!ccpp_utils.real_kind<"kind_phys">>) -> ()
// CHECK-NEXT:        %7 = "ccpp_utils.host_var_ref"() <{var_name = "lc_temp", module_name = ""}> : () -> memref<?x?x!ccpp_utils.real_kind<"kind_phys">>
