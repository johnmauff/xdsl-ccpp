...
// CHECK-LABEL:   subroutine Kw_ccpp_is_scheme_constituent(std_name, is_const, errflg, errmsg)
...
// CHECK-LABEL:   subroutine Kw_ccpp_deallocate_dynamic_constituents()
...
// CHECK-LABEL:   subroutine Kw_ccpp_register_constituents(host_constituents, errmsg, errcode)
...
// CHECK-LABEL:   subroutine Kw_ccpp_number_constituents(num_advected, errmsg, errcode, advected)
...
// CHECK-NEXT:    function Kw_constituents_array() result(ptr)
...
// CHECK-NEXT:    function Kw_model_const_properties() result(ptr)
