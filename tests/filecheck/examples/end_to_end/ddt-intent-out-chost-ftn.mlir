...
// CHECK:           subroutine DdtIn_ccpp_register_constituents(host_constituents, errmsg, errflg)
...
// CHECK:           subroutine DdtIn_ccpp_number_constituents(num_advected, errmsg, errflg)
