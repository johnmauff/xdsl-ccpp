...
// CHECK-LABEL:   subroutine tiny_suite_physics(col_start, col_end, nz, temp, theta, errmsg, errflg)
...
// CHECK-NEXT:          call tiny_suite_physics(col_start, col_end, nz_total, temperature(col_start:col_end),     &
// CHECK-NEXT:            theta_col, errmsg, errflg)
