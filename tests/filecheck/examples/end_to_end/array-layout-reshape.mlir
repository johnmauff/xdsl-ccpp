...
// CHECK-NEXT:   public :: tiny_suite_suite_init_physics
// CHECK-NEXT:   public :: tiny_suite_suite_physics
// CHECK-NEXT:   public :: tiny_suite_suite_timestep_init_physics
// CHECK-NEXT:   public :: tiny_suite_suite_timestep_final_physics
// CHECK-NEXT:   public :: tiny_suite_suite_final_physics
// CHECK: CONTAINS
...
// CHECK-LABEL:   subroutine tiny_suite_suite_init_physics(errflg, errmsg) 
// CHECK:     integer, intent(out) :: errflg
// CHECK-NEXT:     character(len=512), intent(out) :: errmsg
// CHECK:     errflg = 0    
// CHECK-NEXT:     errmsg = ''
...
// CHECK-NEXT:       errflg = 1      
// CHECK-NEXT:     end if
// CHECK-NEXT:   end subroutine tiny_suite_suite_init_physics 
...
// CHECK-LABEL:   subroutine tiny_suite_suite_timestep_init_physics(errflg, errmsg) 
// CHECK:     integer, intent(out) :: errflg
// CHECK-NEXT:     character(len=512), intent(out) :: errmsg
// CHECK:     errflg = 0    
// CHECK-NEXT:     errmsg = ''
// CHECK-NEXT:     ccpp_suite_state = const_in_time_step
// CHECK-NEXT:   end subroutine tiny_suite_suite_timestep_init_physics 
// CHECK-LABEL:   subroutine tiny_suite_suite_timestep_final_physics(errflg, errmsg) 
// CHECK:     integer, intent(out) :: errflg
// CHECK-NEXT:     character(len=512), intent(out) :: errmsg
// CHECK:     errflg = 0    
// CHECK-NEXT:     errmsg = ''
// CHECK-NEXT:     ccpp_suite_state = const_initialized
// CHECK-NEXT:   end subroutine tiny_suite_suite_timestep_final_physics 
// CHECK-LABEL:   subroutine tiny_suite_suite_final_physics(errflg, errmsg) 
// CHECK:     integer, intent(out) :: errflg
// CHECK-NEXT:     character(len=512), intent(out) :: errmsg
// CHECK:     errflg = 0    
// CHECK-NEXT:     errmsg = ''
...
// CHECK-NEXT:       errflg = 1      
// CHECK-NEXT:     end if
// CHECK-NEXT:   end subroutine tiny_suite_suite_final_physics 
...
// CHECK-NEXT:   use tiny_suite_cap, only: tiny_suite_suite_final_physics
// CHECK-NEXT:   use tiny_suite_cap, only: tiny_suite_suite_finalize
// CHECK-NEXT:   use tiny_suite_cap, only: tiny_suite_suite_init_physics
...
// CHECK-NEXT:   use tiny_suite_cap, only: tiny_suite_suite_timestep_final_physics
// CHECK-NEXT:   use tiny_suite_cap, only: tiny_suite_suite_timestep_init_physics
// CHECK:   implicit none
// CHECK-NEXT:   private
...
// CHECK-NEXT:     if (trim(suite_name) .eq. 'tiny_suite') then
// CHECK-NEXT:       if (trim(suite_part) .eq. 'physics') then
// CHECK-NEXT:         call tiny_suite_suite_timestep_init_physics(errflg, errmsg)
// CHECK-NEXT:       else
// CHECK-NEXT:         write(errmsg, '(3a)') "No suite part named ", trim(suite_part),                           &
// CHECK-NEXT:           " found in suite tiny_suite"
// CHECK-NEXT:         errflg = 1        
...
// CHECK-NEXT:     if (trim(suite_name) .eq. 'tiny_suite') then
// CHECK-NEXT:       if (trim(suite_part) .eq. 'physics') then
// CHECK-NEXT:         call tiny_suite_suite_timestep_final_physics(errflg, errmsg)
// CHECK-NEXT:       else
// CHECK-NEXT:         write(errmsg, '(3a)') "No suite part named ", trim(suite_part),                           &
// CHECK-NEXT:           " found in suite tiny_suite"
// CHECK-NEXT:         errflg = 1        
...
// CHECK-NEXT:     if (trim(suite_name) .eq. 'tiny_suite') then
// CHECK-NEXT:       if (trim(suite_part) .eq. 'physics') then
// CHECK-NEXT:         call tiny_suite_suite_init_physics(errflg, errmsg)
// CHECK-NEXT:       else
// CHECK-NEXT:         write(errmsg, '(3a)') "No suite part named ", trim(suite_part),                           &
// CHECK-NEXT:           " found in suite tiny_suite"
// CHECK-NEXT:         errflg = 1        
...
// CHECK-NEXT:     if (trim(suite_name) .eq. 'tiny_suite') then
// CHECK-NEXT:       if (trim(suite_part) .eq. 'physics') then
// CHECK-NEXT:         call tiny_suite_suite_final_physics(errflg, errmsg)
// CHECK-NEXT:       else
// CHECK-NEXT:         write(errmsg, '(3a)') "No suite part named ", trim(suite_part),                           &
// CHECK-NEXT:           " found in suite tiny_suite"
// CHECK-NEXT:         errflg = 1        
