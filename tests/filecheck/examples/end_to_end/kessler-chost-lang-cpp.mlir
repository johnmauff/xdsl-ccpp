...
// CHECK-NEXT:    public :: kessler_suite_register
// CHECK-NEXT:    public :: kessler_suite_initialize
// CHECK-NEXT:    public :: kessler_suite_finalize
// CHECK-NEXT:    public :: kessler_suite_init_physics
// CHECK-NEXT:    public :: kessler_suite_physics
// CHECK-NEXT:    public :: kessler_suite_timestep_init_physics
// CHECK-NEXT:    public :: kessler_suite_timestep_final_physics
// CHECK-NEXT:    public :: kessler_suite_final_physics
// CHECK:       CONTAINS
// CHECK-LABEL:   subroutine kessler_suite_register(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
// CHECK-NEXT:    end subroutine kessler_suite_register
// CHECK-LABEL:   subroutine kessler_suite_initialize(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
...
// CHECK-NEXT:    end subroutine kessler_suite_initialize
// CHECK-LABEL:   subroutine kessler_suite_finalize(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
...
// CHECK-NEXT:    end subroutine kessler_suite_finalize
// CHECK-LABEL:   subroutine kessler_suite_init_physics(lv_in, pref_in, rhoqr_in, gravit_in, errmsg, errflg)
...
// CHECK-NEXT:      if (.NOT. (const_initialized .eq. ccpp_suite_state)) then
// CHECK-NEXT:        write(errmsg, '(3a)') "Invalid initial CCPP state, '", trim(ccpp_suite_state),              &
// CHECK-NEXT:          "' in kessler_suite_init_physics"
// CHECK-NEXT:        errflg = 1
// CHECK-NEXT:      end if
...
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine kessler_suite_init_physics
// CHECK-LABEL:   subroutine kessler_suite_physics(ncol, nz, dt, lyr_surf, lyr_toa, cpair, rair, rho, z, pk,      &
// CHECK:           theta, qv, qc, qr, precl, relhum, temp_prev, ttend_t, scheme_name, errmsg, errflg)
...
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine kessler_suite_physics
// CHECK-LABEL:   subroutine kessler_suite_timestep_init_physics(ncol, nz, temp, temp_prev, ttend_t, errmsg,      &
// CHECK:           errflg)
// CHECK-NEXT:      integer, intent(in) :: ncol
// CHECK-NEXT:      integer, intent(in) :: nz
...
// CHECK-NEXT:    end subroutine kessler_suite_timestep_init_physics
// CHECK-LABEL:   subroutine kessler_suite_timestep_final_physics(nz, ncol, cpair, temp, zm, phis, st_energy,     &
// CHECK:           errmsg, errflg)
// CHECK-NEXT:      integer, intent(in) :: nz
// CHECK-NEXT:      integer, intent(in) :: ncol
// CHECK-NEXT:      real(kind=kind_phys), target, intent(in) :: cpair(:, :)
...
// CHECK-NEXT:      end if
// CHECK-NEXT:      ccpp_suite_state = const_initialized
// CHECK-NEXT:    end subroutine kessler_suite_timestep_final_physics
// CHECK-LABEL:   subroutine kessler_suite_final_physics(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
// CHECK-NEXT:      if (.NOT. (const_initialized .eq. ccpp_suite_state)) then
// CHECK-NEXT:        write(errmsg, '(3a)') "Invalid initial CCPP state, '", trim(ccpp_suite_state),              &
// CHECK-NEXT:          "' in kessler_suite_final_physics"
// CHECK-NEXT:        errflg = 1
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine kessler_suite_final_physics
...
// CHECK-NEXT:    use kessler_suite_cap, only: kessler_suite_final_physics
// CHECK-NEXT:    use kessler_suite_cap, only: kessler_suite_finalize
// CHECK-NEXT:    use kessler_suite_cap, only: kessler_suite_init_physics
// CHECK-NEXT:    use kessler_suite_cap, only: kessler_suite_initialize
// CHECK-NEXT:    use kessler_suite_cap, only: kessler_suite_physics
// CHECK-NEXT:    use kessler_suite_cap, only: kessler_suite_register
// CHECK-NEXT:    use kessler_suite_cap, only: kessler_suite_timestep_final_physics
// CHECK-NEXT:    use kessler_suite_cap, only: kessler_suite_timestep_init_physics
// CHECK:         implicit none
// CHECK-NEXT:    private
...
// CHECK-NEXT:          call kessler_suite_physics(ncol, nz, dt, lyr_surf, lyr_toa,                               &
...
// CHECK-NEXT:        ncol = col_end - col_start + 1
// CHECK-NEXT:        if (trim(suite_part_f) .eq. 'physics') then
// CHECK-NEXT:          call kessler_suite_timestep_init_physics(ncol, nz, temp(col_start:col_end, 1:nz),         &
...
// CHECK-NEXT:        ncol = col_end - col_start + 1
// CHECK-NEXT:        if (trim(suite_part_f) .eq. 'physics') then
// CHECK-NEXT:          call kessler_suite_timestep_final_physics(nz, ncol, cpair(col_start:col_end, 1:nz),       &
// CHECK-NEXT:            temp(col_start:col_end, 1:nz), z(col_start:col_end, 1:nz), phis(col_start:col_end),     &
// CHECK-NEXT:            st_energy(col_start:col_end, 1:nz), errmsg_f, errflg)
// CHECK-NEXT:        else
// CHECK-NEXT:          write(errmsg_f, '(3a)') "No suite part named ", trim(suite_part_f),                       &
// CHECK-NEXT:            " found in suite kessler_suite"
// CHECK-NEXT:          errflg = 1
...
// CHECK-NEXT:      if (trim(suite_name_f) .eq. 'kessler_suite') then
// CHECK-NEXT:        if (trim(suite_part_f) .eq. 'physics') then
// CHECK-NEXT:          call kessler_suite_init_physics(lv, pref, rhoqr, gravit, errmsg_f, errflg)
// CHECK-NEXT:        else
// CHECK-NEXT:          write(errmsg_f, '(3a)') "No suite part named ", trim(suite_part_f),                       &
// CHECK-NEXT:            " found in suite kessler_suite"
// CHECK-NEXT:          errflg = 1
