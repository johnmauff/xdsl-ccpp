// Test the cpp_header target for the tinyddt chost cap with DDT flattening.
// Verifies that the expanded DDT members appear as C-compatible types:
//   - state_nz as int (integer member of tiny_state_t)
//   - state_temp as double* (real array member, intent(inout))
//
...
// Run: ncol; state_nz (is_nz before others); col_start/col_end; state_temp; errmsg; errflg.
