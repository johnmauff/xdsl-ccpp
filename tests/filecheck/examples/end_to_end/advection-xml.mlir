...
// CHECK:   subroutine cld_suite_suite_initialize(const_std_name, num_consts, test_stdname_array,           &
...
// CHECK:   subroutine cld_suite_suite_finalize(errmsg, errflg)
// CHECK-NEXT:     character(len=512), intent(out) :: errmsg
// CHECK-NEXT:     integer, intent(out) :: errflg
// CHECK:     errflg = 0
// CHECK-NEXT:     errmsg = ''
...
// CHECK:   subroutine cld_suite_suite_physics(const_std_name, num_consts, test_stdname_array, const_inds,  &
...
// CHECK: CONTAINS
// CHECK:   subroutine ccpp_register(suite_name, errmsg, errflg)
...
// CHECK:   subroutine ccpp_init(suite_name, errmsg, errflg)
// CHECK-NEXT:     character(len=*), intent(in) :: suite_name
// CHECK-NEXT:     character(len=512), intent(out) :: errmsg
// CHECK-NEXT:     integer, intent(out) :: errflg
// CHECK:     errflg = 0
...
// CHECK:   subroutine ccpp_final(suite_name, errmsg, errflg)
// CHECK-NEXT:     character(len=*), intent(in) :: suite_name
// CHECK-NEXT:     character(len=512), intent(out) :: errmsg
// CHECK-NEXT:     integer, intent(out) :: errflg
// CHECK:     errflg = 0
...
// CHECK:   subroutine ccpp_physics_run(suite_name, suite_part, col_start, col_end, errmsg, errflg)
// CHECK-NEXT:     character(len=*), intent(in) :: suite_name
...
// CHECK-NEXT:           ncol, dt, phys_state%Temp(col_start:col_end, 1:pver), phys_state%q(col_start:col_end,   &
// CHECK-NEXT:           1:pver, index_qv), phys_state%ps(col_start:col_end), lc_cld_liq_tend(col_start:col_end, &
...
// CHECK:   subroutine ccpp_physics_suite_part_list(suite_name, part_list, errmsg, errflg)
// CHECK-NEXT:     character(len=*), intent(in) :: suite_name
...
// CHECK-NEXT:   subroutine ccpp_physics_suite_variables(suite_name, var_list, errmsg, errflg, input_vars,       &
