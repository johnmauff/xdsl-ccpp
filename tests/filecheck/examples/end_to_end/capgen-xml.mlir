...
// CHECK-NEXT:    public :: temp_suite_register
// CHECK-NEXT:    public :: temp_suite_initialize
// CHECK-NEXT:    public :: temp_suite_finalize
// CHECK-NEXT:    public :: temp_suite_init_physics1
// CHECK-NEXT:    public :: temp_suite_physics1
// CHECK-NEXT:    public :: temp_suite_timestep_init_physics1
// CHECK-NEXT:    public :: temp_suite_timestep_final_physics1
// CHECK-NEXT:    public :: temp_suite_final_physics1
// CHECK-NEXT:    public :: temp_suite_init_physics2
// CHECK-NEXT:    public :: temp_suite_physics2
// CHECK-NEXT:    public :: temp_suite_timestep_init_physics2
// CHECK-NEXT:    public :: temp_suite_timestep_final_physics2
// CHECK-NEXT:    public :: temp_suite_final_physics2
// CHECK:       CONTAINS
// CHECK-LABEL:   subroutine temp_suite_register(config_var, errmsg, errflg)
...
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine temp_suite_register
// CHECK-LABEL:   subroutine temp_suite_initialize(errflg, errmsg)
...
// CHECK-NEXT:    end subroutine temp_suite_initialize
// CHECK-LABEL:   subroutine temp_suite_finalize(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
...
// CHECK-NEXT:    end subroutine temp_suite_finalize
// CHECK-LABEL:   subroutine temp_suite_init_physics1(temp_inc_in, fudge, errmsg, errflg)
...
// CHECK-NEXT:      if (.NOT. (const_initialized .eq. ccpp_suite_state)) then
// CHECK-NEXT:        write(errmsg, '(3a)') "Invalid initial CCPP state, '", trim(ccpp_suite_state),              &
// CHECK-NEXT:          "' in temp_suite_init_physics1"
// CHECK-NEXT:        errflg = 1
// CHECK-NEXT:      end if
// CHECK-NEXT:      if (errflg .eq. 0) then
...
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine temp_suite_init_physics1
// CHECK-LABEL:   subroutine temp_suite_physics1(ncol, lev, timestep, temp_level, temp_diag, temp, ps,            &
...
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine temp_suite_physics1
// CHECK-LABEL:   subroutine temp_suite_timestep_init_physics1(coeffs, ncol, temp_level, errmsg, errflg)
...
// CHECK-NEXT:    end subroutine temp_suite_timestep_init_physics1
// CHECK-LABEL:   subroutine temp_suite_timestep_final_physics1(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
// CHECK-NEXT:      ccpp_suite_state = const_initialized
// CHECK-NEXT:    end subroutine temp_suite_timestep_final_physics1
// CHECK-LABEL:   subroutine temp_suite_final_physics1(errmsg, errflg)
...
// CHECK-NEXT:      if (.NOT. (const_initialized .eq. ccpp_suite_state)) then
// CHECK-NEXT:        write(errmsg, '(3a)') "Invalid initial CCPP state, '", trim(ccpp_suite_state),              &
// CHECK-NEXT:          "' in temp_suite_final_physics1"
// CHECK-NEXT:        errflg = 1
// CHECK-NEXT:      end if
// CHECK-NEXT:      if (errflg .eq. 0) then
// CHECK-NEXT:        call temp_set_finalize(errmsg=errmsg, errflg=errflg)
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine temp_suite_final_physics1
// CHECK-LABEL:   subroutine temp_suite_init_physics2(errmsg, errflg)
// CHECK:           character(len=512), intent(out) :: errmsg
// CHECK-NEXT:      integer, intent(out) :: errflg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
...
// CHECK-NEXT:      if (.NOT. (const_initialized .eq. ccpp_suite_state)) then
// CHECK-NEXT:        write(errmsg, '(3a)') "Invalid initial CCPP state, '", trim(ccpp_suite_state),              &
// CHECK-NEXT:          "' in temp_suite_init_physics2"
// CHECK-NEXT:        errflg = 1
// CHECK-NEXT:      end if
// CHECK-NEXT:      if (errflg .eq. 0) then
...
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine temp_suite_init_physics2
// CHECK-LABEL:   subroutine temp_suite_physics2(nbox, timestep, temp_level, temp_layer, qv, ps, errmsg, errflg)
...
// CHECK-NEXT:        end if
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine temp_suite_physics2
// CHECK-LABEL:   subroutine temp_suite_timestep_init_physics2(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
// CHECK-NEXT:      ccpp_suite_state = const_in_time_step
// CHECK-NEXT:    end subroutine temp_suite_timestep_init_physics2
// CHECK-LABEL:   subroutine temp_suite_timestep_final_physics2(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
// CHECK-NEXT:      ccpp_suite_state = const_initialized
// CHECK-NEXT:    end subroutine temp_suite_timestep_final_physics2
// CHECK-LABEL:   subroutine temp_suite_final_physics2(errmsg, errflg)
// CHECK:           character(len=512), intent(out) :: errmsg
// CHECK-NEXT:      integer, intent(out) :: errflg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
// CHECK-NEXT:      if (.NOT. (const_initialized .eq. ccpp_suite_state)) then
// CHECK-NEXT:        write(errmsg, '(3a)') "Invalid initial CCPP state, '", trim(ccpp_suite_state),              &
// CHECK-NEXT:          "' in temp_suite_final_physics2"
// CHECK-NEXT:        errflg = 1
// CHECK-NEXT:      end if
// CHECK-NEXT:      if (errflg .eq. 0) then
...
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine temp_suite_final_physics2
...
// CHECK-NEXT:    public :: ddt_suite_register
// CHECK-NEXT:    public :: ddt_suite_initialize
// CHECK-NEXT:    public :: ddt_suite_finalize
// CHECK-NEXT:    public :: ddt_suite_init_data_prep
// CHECK-NEXT:    public :: ddt_suite_data_prep
// CHECK-NEXT:    public :: ddt_suite_timestep_init_data_prep
// CHECK-NEXT:    public :: ddt_suite_timestep_final_data_prep
// CHECK-NEXT:    public :: ddt_suite_final_data_prep
// CHECK:       CONTAINS
// CHECK-LABEL:   subroutine ddt_suite_register(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
...
// CHECK-NEXT:      end if
// CHECK-NEXT:      ccpp_suite_state = const_initialized
// CHECK-NEXT:    end subroutine ddt_suite_initialize
// CHECK-LABEL:   subroutine ddt_suite_finalize(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
...
// CHECK-NEXT:      end if
// CHECK-NEXT:      ccpp_suite_state = const_uninitialized
// CHECK-NEXT:    end subroutine ddt_suite_finalize
// CHECK-LABEL:   subroutine ddt_suite_init_data_prep(nbox, model_times, errmsg, errflg, ntimes)
// CHECK:           integer, intent(in) :: nbox
...
// CHECK-NEXT:      if (.NOT. (const_initialized .eq. ccpp_suite_state)) then
// CHECK-NEXT:        write(errmsg, '(3a)') "Invalid initial CCPP state, '", trim(ccpp_suite_state),              &
// CHECK-NEXT:          "' in ddt_suite_init_data_prep"
// CHECK-NEXT:        errflg = 1
// CHECK-NEXT:      end if
// CHECK-NEXT:      if (errflg .eq. 0) then
...
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine ddt_suite_init_data_prep
// CHECK-LABEL:   subroutine ddt_suite_data_prep(cols, cole, psurf, errmsg, errflg)
...
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine ddt_suite_data_prep
// CHECK-LABEL:   subroutine ddt_suite_timestep_init_data_prep(errflg, errmsg)
// CHECK:           integer, intent(out) :: errflg
// CHECK-NEXT:      character(len=512), intent(out) :: errmsg
// CHECK:           errflg = 0
// CHECK-NEXT:      errmsg = ''
// CHECK-NEXT:      ccpp_suite_state = const_in_time_step
// CHECK-NEXT:    end subroutine ddt_suite_timestep_init_data_prep
// CHECK-LABEL:   subroutine ddt_suite_timestep_final_data_prep(ncols, errmsg, errflg)
...
// CHECK-NEXT:      end if
// CHECK-NEXT:      ccpp_suite_state = const_initialized
// CHECK-NEXT:    end subroutine ddt_suite_timestep_final_data_prep
// CHECK-LABEL:   subroutine ddt_suite_final_data_prep(ntimes, model_times, errmsg, errflg)
...
// CHECK-NEXT:      if (.NOT. (const_initialized .eq. ccpp_suite_state)) then
// CHECK-NEXT:        write(errmsg, '(3a)') "Invalid initial CCPP state, '", trim(ccpp_suite_state),              &
// CHECK-NEXT:          "' in ddt_suite_final_data_prep"
// CHECK-NEXT:        errflg = 1
// CHECK-NEXT:      end if
// CHECK-NEXT:      if (errflg .eq. 0) then
...
// CHECK-NEXT:      end if
// CHECK-NEXT:    end subroutine ddt_suite_final_data_prep
// CHECK-NEXT:  end module ddt_suite_cap
// CHECK:       // -----
// CHECK-LABEL: // FILE: Ddt_ccpp_cap.F90
// CHECK-LABEL: module Ddt_ccpp_cap
// CHECK:         use ccpp_kinds
// CHECK-NEXT:    use ddt_suite_cap, only: ddt_suite_data_prep
// CHECK-NEXT:    use ddt_suite_cap, only: ddt_suite_final_data_prep
// CHECK-NEXT:    use ddt_suite_cap, only: ddt_suite_finalize
// CHECK-NEXT:    use ddt_suite_cap, only: ddt_suite_init_data_prep
// CHECK-NEXT:    use ddt_suite_cap, only: ddt_suite_initialize
// CHECK-NEXT:    use ddt_suite_cap, only: ddt_suite_register
// CHECK-NEXT:    use ddt_suite_cap, only: ddt_suite_timestep_final_data_prep
// CHECK-NEXT:    use ddt_suite_cap, only: ddt_suite_timestep_init_data_prep
// CHECK-NEXT:    use make_ddt, only: vmr_type
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_final_physics1
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_final_physics2
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_finalize
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_init_physics1
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_init_physics2
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_initialize
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_physics1
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_physics2
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_register
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_timestep_final_physics1
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_timestep_final_physics2
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_timestep_init_physics1
// CHECK-NEXT:    use temp_suite_cap, only: temp_suite_timestep_init_physics2
...
// CHECK-NEXT:        call ddt_suite_register(errflg, errmsg)
// CHECK-NEXT:      else
// CHECK-NEXT:        if (trim(suite_name) .eq. 'temp_suite') then
// CHECK-NEXT:          call temp_suite_register(config_var, errmsg, errflg)
// CHECK-NEXT:        else
...
// CHECK:           errflg = 0
// CHECK-NEXT:      if (trim(suite_name) .eq. 'ddt_suite') then
// CHECK-NEXT:        call ddt_suite_initialize(errflg, errmsg)
// CHECK-NEXT:      else
// CHECK-NEXT:        if (trim(suite_name) .eq. 'temp_suite') then
// CHECK-NEXT:          call temp_suite_initialize(errflg, errmsg)
// CHECK-NEXT:        else
// CHECK-NEXT:          write(errmsg, '(3a)') "No suite named ", trim(suite_name), " found"
// CHECK-NEXT:          errflg = 1
// CHECK-NEXT:        end if
...
// CHECK:           errflg = 0
// CHECK-NEXT:      if (trim(suite_name) .eq. 'ddt_suite') then
// CHECK-NEXT:        call ddt_suite_finalize(errflg, errmsg)
// CHECK-NEXT:      else
// CHECK-NEXT:        if (trim(suite_name) .eq. 'temp_suite') then
// CHECK-NEXT:          call temp_suite_finalize(errflg, errmsg)
// CHECK-NEXT:        else
// CHECK-NEXT:          write(errmsg, '(3a)') "No suite named ", trim(suite_name), " found"
// CHECK-NEXT:          errflg = 1
// CHECK-NEXT:        end if
...
// CHECK-NEXT:          call ddt_suite_data_prep(cols, cole, phys_state%ps(cols:cole), errmsg, errflg)
// CHECK-NEXT:        else
...
// CHECK-NEXT:            call temp_suite_physics1(ncol, pver, dt, temp_interfaces(cols:cole, 1:pverP),           &
...
// CHECK-NEXT:              call temp_suite_physics2(nbox=nbox, timestep=dt,                                      &
...
// CHECK-NEXT:      if (trim(suite_name) .eq. 'ddt_suite') then
// CHECK-NEXT:        if (trim(suite_part) .eq. 'data_prep') then
// CHECK-NEXT:          call ddt_suite_timestep_init_data_prep(errflg, errmsg)
// CHECK-NEXT:        else
// CHECK-NEXT:          write(errmsg, '(3a)') "No suite part named ", trim(suite_part), " found in suite ddt_suite"
// CHECK-NEXT:          errflg = 1
// CHECK-NEXT:        end if
...
// CHECK-NEXT:          if (trim(suite_part) .eq. 'physics1') then
// CHECK-NEXT:            call temp_suite_timestep_init_physics1(coeffs(col_start:col_end), ncol,                 &
// CHECK-NEXT:              temp_interfaces(col_start:col_end, 1:pverP), errmsg, errflg)
// CHECK-NEXT:          else
// CHECK-NEXT:            if (trim(suite_part) .eq. 'physics2') then
// CHECK-NEXT:              call temp_suite_timestep_init_physics2(errflg, errmsg)
// CHECK-NEXT:            else
// CHECK-NEXT:              write(errmsg, '(3a)') "No suite part named ", trim(suite_part),                       &
// CHECK-NEXT:                " found in suite temp_suite"
// CHECK-NEXT:              errflg = 1
...
// CHECK-NEXT:      character(len=512), intent(inout) :: errmsg
// CHECK-NEXT:      integer, intent(inout) :: errflg
// CHECK-NEXT:      integer :: ncols
// CHECK:           errflg = 0
// CHECK-NEXT:      if (trim(suite_name) .eq. 'ddt_suite') then
// CHECK-NEXT:        ncols = col_end - col_start + 1
// CHECK-NEXT:        if (trim(suite_part) .eq. 'data_prep') then
// CHECK-NEXT:          call ddt_suite_timestep_final_data_prep(ncols, errmsg, errflg)
// CHECK-NEXT:        else
// CHECK-NEXT:          write(errmsg, '(3a)') "No suite part named ", trim(suite_part), " found in suite ddt_suite"
// CHECK-NEXT:          errflg = 1
// CHECK-NEXT:        end if
...
// CHECK-NEXT:        if (trim(suite_name) .eq. 'temp_suite') then
// CHECK-NEXT:          if (trim(suite_part) .eq. 'physics1') then
// CHECK-NEXT:            call temp_suite_timestep_final_physics1(errflg, errmsg)
// CHECK-NEXT:          else
// CHECK-NEXT:            if (trim(suite_part) .eq. 'physics2') then
// CHECK-NEXT:              call temp_suite_timestep_final_physics2(errflg, errmsg)
// CHECK-NEXT:            else
// CHECK-NEXT:              write(errmsg, '(3a)') "No suite part named ", trim(suite_part),                       &
// CHECK-NEXT:                " found in suite temp_suite"
// CHECK-NEXT:              errflg = 1
...
// CHECK-LABEL:   subroutine ccpp_physics_init(suite_name, suite_part, col_start, col_end, model_times, fudge,    &
// CHECK:           errmsg, errflg)
// CHECK-NEXT:      character(len=*), intent(in) :: suite_name
// CHECK-NEXT:      character(len=*), intent(in) :: suite_part
// CHECK-NEXT:      integer, intent(in) :: col_start
...
// CHECK:           errflg = 0
// CHECK-NEXT:      if (trim(suite_name) .eq. 'ddt_suite') then
// CHECK-NEXT:        nbox = col_end - col_start + 1
// CHECK-NEXT:        if (trim(suite_part) .eq. 'data_prep') then
// CHECK-NEXT:          call ddt_suite_init_data_prep(nbox, model_times, errmsg, errflg, num_model_times)
// CHECK-NEXT:        else
// CHECK-NEXT:          write(errmsg, '(3a)') "No suite part named ", trim(suite_part), " found in suite ddt_suite"
// CHECK-NEXT:          errflg = 1
// CHECK-NEXT:        end if
...
// CHECK-NEXT:        if (trim(suite_name) .eq. 'temp_suite') then
// CHECK-NEXT:          if (trim(suite_part) .eq. 'physics1') then
// CHECK-NEXT:            call temp_suite_init_physics1(temp_inc, fudge, errmsg, errflg)
// CHECK-NEXT:          else
// CHECK-NEXT:            if (trim(suite_part) .eq. 'physics2') then
// CHECK-NEXT:              call temp_suite_init_physics2(errmsg, errflg)
// CHECK-NEXT:            else
// CHECK-NEXT:              write(errmsg, '(3a)') "No suite part named ", trim(suite_part),                       &
// CHECK-NEXT:                " found in suite temp_suite"
// CHECK-NEXT:              errflg = 1
...
// CHECK-NEXT:      if (trim(suite_name) .eq. 'ddt_suite') then
// CHECK-NEXT:        if (trim(suite_part) .eq. 'data_prep') then
// CHECK-NEXT:          call ddt_suite_final_data_prep(num_model_times, model_times, errmsg, errflg)
// CHECK-NEXT:        else
// CHECK-NEXT:          write(errmsg, '(3a)') "No suite part named ", trim(suite_part), " found in suite ddt_suite"
// CHECK-NEXT:          errflg = 1
// CHECK-NEXT:        end if
...
// CHECK-NEXT:        if (trim(suite_name) .eq. 'temp_suite') then
// CHECK-NEXT:          if (trim(suite_part) .eq. 'physics1') then
// CHECK-NEXT:            call temp_suite_final_physics1(errmsg, errflg)
// CHECK-NEXT:          else
// CHECK-NEXT:            if (trim(suite_part) .eq. 'physics2') then
// CHECK-NEXT:              call temp_suite_final_physics2(errmsg, errflg)
// CHECK-NEXT:            else
// CHECK-NEXT:              write(errmsg, '(3a)') "No suite part named ", trim(suite_part),                       &
// CHECK-NEXT:                " found in suite temp_suite"
// CHECK-NEXT:              errflg = 1
