...
// CHECK-NEXT:   public :: var_compatibility_suite_suite_init_radiation
...
// CHECK-NEXT:   public :: var_compatibility_suite_suite_final_radiation
// CHECK: CONTAINS
...
// CHECK-LABEL:   subroutine var_compatibility_suite_suite_initialize(errflg, errmsg) 
// CHECK:     integer, intent(out) :: errflg
// CHECK-NEXT:     character(len=512), intent(out) :: errmsg
// CHECK:     errflg = 0    
// CHECK-NEXT:     errmsg = ''
...
// CHECK-NEXT:     end if
// CHECK-NEXT:   end subroutine var_compatibility_suite_suite_init_radiation 
...
// CHECK-LABEL:   subroutine var_compatibility_suite_suite_timestep_init_radiation(errflg, errmsg) 
// CHECK:     integer, intent(out) :: errflg
// CHECK-NEXT:     character(len=512), intent(out) :: errmsg
// CHECK:     errflg = 0    
// CHECK-NEXT:     errmsg = ''
...
// CHECK-LABEL:   subroutine var_compatibility_suite_suite_final_radiation(errflg, errmsg) 
// CHECK:     integer, intent(out) :: errflg
// CHECK-NEXT:     character(len=512), intent(out) :: errmsg
// CHECK:     errflg = 0    
// CHECK-NEXT:     errmsg = ''
...
// CHECK-NEXT:       errflg = 1      
// CHECK-NEXT:     end if
// CHECK-NEXT:   end subroutine var_compatibility_suite_suite_final_radiation 
...
// CHECK-NEXT:   use test_host_mod, only: pver
// CHECK-NEXT:   use var_compatibility_suite_cap, only: var_compatibility_suite_suite_final_radiation
// CHECK-NEXT:   use var_compatibility_suite_cap, only: var_compatibility_suite_suite_finalize
// CHECK-NEXT:   use var_compatibility_suite_cap, only: var_compatibility_suite_suite_init_radiation
...
// CHECK:     errflg = 0    
// CHECK-NEXT:     if (trim(suite_name) .eq. 'var_compatibility_suite') then
// CHECK-NEXT:       call var_compatibility_suite_suite_initialize(errflg, errmsg)
// CHECK-NEXT:     else
// CHECK-NEXT:       write(errmsg, '(3a)') "No suite named ", trim(suite_name), " found"
// CHECK-NEXT:       errflg = 1      
// CHECK-NEXT:     end if
...
// CHECK-NEXT:     if (trim(suite_name) .eq. 'var_compatibility_suite') then
// CHECK-NEXT:       if (trim(suite_part) .eq. 'radiation') then
// CHECK-NEXT:         call var_compatibility_suite_suite_timestep_init_radiation(errflg, errmsg)
// CHECK-NEXT:       else
// CHECK-NEXT:         write(errmsg, '(3a)') "No suite part named ", trim(suite_part),                           &
// CHECK-NEXT:           " found in suite var_compatibility_suite"
// CHECK-NEXT:         errflg = 1        
...
// CHECK-NEXT:     if (trim(suite_name) .eq. 'var_compatibility_suite') then
// CHECK-NEXT:       if (trim(suite_part) .eq. 'radiation') then
// CHECK-NEXT:         call var_compatibility_suite_suite_final_radiation(errflg, errmsg)
// CHECK-NEXT:       else
// CHECK-NEXT:         write(errmsg, '(3a)') "No suite part named ", trim(suite_part),                           &
// CHECK-NEXT:           " found in suite var_compatibility_suite"
// CHECK-NEXT:         errflg = 1        
