...
// Run subroutine: ncol and nz as value ints, nbands as value int,
// flux as rank-3 assumed-size real array, then errmsg and errflg.
// CHECK-LABEL:   subroutine TinyR3_chost_physics_run(ncol, nz, nbands, flux, errmsg, errflg) &
...
// Suite cap call forwards ncol and nz correctly.
// CHECK:           call tiny_r3_suite_suite_physics(
// CHECK:               1, ncol, nz, nbands, flux,
