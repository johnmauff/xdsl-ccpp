...
// CHECK-NEXT:      subroutine Tiny_ccpp_is_scheme_constituent(std_name, is_const, errflg, errmsg)
...
// CHECK:           subroutine Tiny_ccpp_deallocate_dynamic_constituents()
...
// CHECK:           subroutine Tiny_ccpp_register_constituents(host_constituents, errmsg, errcode)
...
// CHECK:           subroutine Tiny_ccpp_number_constituents(num_advected, errmsg, errcode, advected)
...
// CHECK:           subroutine Tiny_ccpp_initialize_constituents(ncols, pver, errflg, errmsg)
...
// CHECK:           function Tiny_constituents_array() result(ptr)
...
// CHECK:           subroutine Tiny_const_get_index(std_name, index, errflg, errmsg)
// CHECK-NEXT:        character(len=*), intent(in) :: std_name
...
// CHECK:           function Tiny_model_const_properties() result(ptr)
...
// CHECK:  end module Tiny_ccpp_cap
// CHECK:       // -----
