...
// CHECK:           subroutine Tiny_ccpp_register_constituents(host_constituents, errmsg, errflg)
...
// CHECK:           subroutine Tiny_ccpp_number_constituents(num_advected, errmsg, errflg)
