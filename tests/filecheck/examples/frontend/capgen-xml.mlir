...
// CHECK-NEXT:        "ccpp.arg"() <{name = "errflg", type = "integer", standard_name = "ccpp_error_code", long_name = "Error flag for error handling in CCPP", intent = "out", units = "1"}> : () -> ()
// CHECK-NEXT:      }) : () -> ()
// CHECK-NEXT:    }) {source_module = "temp_set", kind_specs = ["temp_kinds:kind_temp=>temp_r8"], dependencies = ["temp_kinds.F90"]} : () -> ()
...
// CHECK-NEXT:        "ccpp.arg"() <{name = "errflg", type = "integer", standard_name = "ccpp_error_code", long_name = "Error flag for error handling in CCPP", intent = "out", units = "1"}> : () -> ()
// CHECK-NEXT:      }) : () -> ()
// CHECK-NEXT:    }) {source_module = "temp_adjust", kind_specs = ["temp_kinds:kind_temp=>temp_r8"], dependencies = ["temp_kinds.F90"]} : () -> ()
