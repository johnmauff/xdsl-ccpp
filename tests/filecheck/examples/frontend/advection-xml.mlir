...
// CHECK-NEXT:        "ccpp.arg"() <{name = "cld_liq_tend", type = "real", dimensions = #builtin.int<2>, dim_names = "horizontal_loop_extent,vertical_layer_dimension", standard_name = "tendency_of_cloud_liquid_dry_mixing_ratio", kind = "kind_phys", intent = "inout", units = "kg kg-1 s-1", constituent}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "errmsg", type = "character", standard_name = "ccpp_error_message", long_name = "Error message for error handling in CCPP", kind = "len=512", intent = "out", units = "none"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "errflg", type = "integer", standard_name = "ccpp_error_code", long_name = "Error flag for error handling in CCPP", intent = "out", units = "1"}> : () -> ()
// CHECK-NEXT:      }) : () -> ()
...
// CHECK-NEXT:        "ccpp.arg"() <{name = "cld_liq_array", type = "real", dimensions = #builtin.int<2>, dim_names = "horizontal_dimension,vertical_layer_dimension", standard_name = "cloud_liquid_dry_mixing_ratio", kind = "kind_phys", intent = "out", units = "kg kg-1", advected}> : () -> ()
