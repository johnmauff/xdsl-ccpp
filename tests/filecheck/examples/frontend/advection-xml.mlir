...
// CHECK-NEXT:        "ccpp.arg"() <{name = "const_tend", type = "real", dimensions = #builtin.int<3>, dim_names = "horizontal_loop_extent,vertical_layer_dimension,number_of_ccpp_constituents", standard_name = "ccpp_constituent_tendencies", long_name = "ccpp constituent tendencies", kind = "kind_phys", intent = "inout", units = "none", memory_space = "device"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "const", type = "real", dimensions = #builtin.int<3>, dim_names = "horizontal_loop_extent,vertical_layer_dimension,number_of_ccpp_constituents", standard_name = "ccpp_constituents", long_name = "ccpp constituents", kind = "kind_phys", intent = "inout", units = "none", memory_space = "device"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "errcode", type = "integer", standard_name = "ccpp_error_code", long_name = "Error flag for error handling in CCPP", intent = "out", units = "1"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "errmsg", type = "character", standard_name = "ccpp_error_message", long_name = "Error message for error handling in CCPP", kind = "len=512", intent = "out", units = "none"}> : () -> ()
// CHECK-NEXT:      }) : () -> ()
