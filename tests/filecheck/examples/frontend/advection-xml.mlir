...
// Exercises: five distinct schemes, apply_constituent_tendencies appearing
// twice in the suite group (duplicate scheme entries in the XML), host and
// module table types, 3-D array arguments, and cld_shadow -- a scheme whose
// own local arg names ("cld_ice_array", "ncols") reuse a constituent's and
// the host's own names for unrelated standard_names (capgen-v1 GitHub
// issues #772/#774).
//
...
// CHECK-NEXT:        "ccpp.scheme"() <{scheme_name = "apply_constituent_tendencies"}> : () -> ()
// CHECK-NEXT:        "ccpp.scheme"() <{scheme_name = "cld_shadow"}> : () -> ()
// CHECK-NEXT:      }) : () -> ()
// CHECK-NEXT:    }) : () -> ()
...
// CHECK-NEXT:        "ccpp.arg"() <{name = "temp", type = "real", dimensions = #builtin.int<2>, dim_names = "horizontal_dimension,vertical_LAYER_dimension", standard_name = "temperature", kind = "kind_phys", intent = "inout", units = "K", memory_space = "device"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "qv", type = "real", dimensions = #builtin.int<2>, dim_names = "horizontal_dimension,vertical_layer_dimension", standard_name = "water_vapor_specific_humidity", kind = "kind_phys", intent = "inout", units = "kg kg-1", memory_space = "device"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "ps", type = "real", dimensions = #builtin.int<1>, dim_names = "horizontal_dimension", standard_name = "surface_air_pressure", kind = "kind_phys", intent = "in", units = "hPa", state_variable}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "cld_liq_tend", type = "real", dimensions = #builtin.int<2>, dim_names = "horizontal_dimension,vertical_layer_dimension", standard_name = "tendency_of_cloud_liquid_dry_mixing_ratio", kind = "kind_phys", intent = "inout", units = "kg kg-1 s-1", memory_space = "device", constituent}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "errmsg", type = "character", standard_name = "ccpp_error_message", long_name = "Error message for error handling in CCPP", kind = "len=512", intent = "out", units = "none"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "errflg", type = "integer", standard_name = "ccpp_error_code", long_name = "Error flag for error handling in CCPP", intent = "out", units = "1"}> : () -> ()
// CHECK-NEXT:      }) : () -> ()
...
// CHECK-NEXT:        "ccpp.arg"() <{name = "cld_ice_array", type = "real", dimensions = #builtin.int<2>, dim_names = "horizontal_dimension,vertical_layer_dimension", standard_name = "cloud_ice_dry_mixing_ratio", kind = "kind_phys", intent = "inout", units = "kg kg-1", default_value = "0.0_kind_phys", advected}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "errmsg", type = "character", standard_name = "ccpp_error_message", long_name = "Error message for error handling in CCPP", kind = "len=512", intent = "out", units = "none"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "errflg", type = "integer", standard_name = "ccpp_error_code", long_name = "Error flag for error handling in CCPP", intent = "out", units = "1"}> : () -> ()
// CHECK-NEXT:      }) : () -> ()
...
// CHECK-NEXT:    "ccpp.table_properties"() <{name = "cld_shadow", type = #ccpp<table_type_kind scheme>}> ({
// CHECK-NEXT:      "ccpp.arg_table"() <{name = "cld_shadow_run", type = #ccpp<table_type_kind scheme>}> ({
// CHECK-NEXT:        "ccpp.arg"() <{name = "ncol", type = "integer", standard_name = "horizontal_dimension", intent = "in", units = "count"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "timestep", type = "real", standard_name = "time_step_for_physics", long_name = "time step", kind = "kind_phys", intent = "in", units = "s"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "cld_ice_array", type = "real", dimensions = #builtin.int<2>, dim_names = "horizontal_dimension,vertical_layer_dimension", standard_name = "cld_shadow_scratch_array", kind = "kind_phys", intent = "out", units = "s"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "ncols", type = "real", dimensions = #builtin.int<1>, dim_names = "horizontal_dimension", standard_name = "cld_shadow_column_scratch", kind = "kind_phys", intent = "out", units = "count"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "errmsg", type = "character", standard_name = "ccpp_error_message", long_name = "Error message for error handling in CCPP", kind = "len=512", intent = "out", units = "none"}> : () -> ()
// CHECK-NEXT:        "ccpp.arg"() <{name = "errflg", type = "integer", standard_name = "ccpp_error_code", long_name = "Error flag for error handling in CCPP", intent = "out", units = "1"}> : () -> ()
// CHECK-NEXT:      }) : () -> ()
// CHECK-NEXT:    }) {source_module = "cld_shadow"} : () -> ()
